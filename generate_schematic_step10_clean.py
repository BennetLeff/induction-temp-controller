#!/usr/bin/env python3
"""
STEP 10: Clean Professional Layout
Improvements:
- Better component spacing and alignment
- All wires horizontal/vertical (no diagonals)
- Visual isolation barrier (dashed line)
...
# Isolation barrier - vertical line
barrier_x = grid(85)

# AC components - right section
j3_x = grid(100)
j3_y = grid(28)
f1_x = grid(115)
f1_y = grid(28)
...
schematic = f"""(kicad_sch
  (version 20231120)
  (generator "step10-professional-layout")
  ...
  (title_block
    ...
    (date "2025-01-28")
    (rev "2.0")
    (comment 1 "Professional Layout - Clean Signal Flow")
  )
...
{SYMBOLS}
  ...
  (text "DC POWER - 5V" (exclude_from_sim no)
    (at {grid(10)} {grid(12)} 0)
    (effects (font (size 3.5 3.5) bold) (justify left))
    (uuid "{guid()}")
  )

  (text "CONTROL LOGIC" (exclude_from_sim no)
    (at {grid(58)} {grid(12)} 0)
    (effects (font (size 3.5 3.5) bold) (justify left))
    (uuid "{guid()}")
  )

  (text "ISOLATION\\nBARRIER" (exclude_from_sim no)
    (at {barrier_x - grid(3)} {grid(12)} 0)
    (effects (font (size 2.5 2.5) bold) (justify center))
    (uuid "{guid()}")
  )

  (text "AC POWER - 120-240V ⚡" (exclude_from_sim no)
    (at {grid(95)} {grid(12)} 0)
    (effects (font (size 3.5 3.5) bold) (justify left))
    (uuid "{guid()}")
  )

  (text "USB-C\\nPower Input" (exclude_from_sim no)
    (at {grid(10)} {grid(28)} 0)
    (effects (font (size 1.5 1.5)) (justify left))
    (uuid "{guid()}")
  )

  (text "Bulk\\nCapacitor" (exclude_from_sim no)
    (at {grid(25)} {grid(37)} 0)
    (effects (font (size 1.27 1.27) italic) (justify left))
    (uuid "{guid()}")
  )

  (text "Current\\nLimiter" (exclude_from_sim no)
    (at {grid(63)} {grid(37)} 0)
    (effects (font (size 1.27 1.27) italic) (justify left))
    (uuid "{guid()}")
  )

  (text "IEC C14\\nAC Inlet" (exclude_from_sim no)
    (at {grid(95)} {grid(25)} 0)
    (effects (font (size 1.5 1.5)) (justify left))
    (uuid "{guid()}")
  )

  (text "Overcurrent\\nProtection" (exclude_from_sim no)
    (at {grid(112)} {grid(37)} 0)
    (effects (font (size 1.27 1.27) italic) (justify left))
    (uuid "{guid()}")
  )

  (text "To Induction\\nCooktop" (exclude_from_sim no)
    (at {grid(143)} {grid(37)} 0)
    (effects (font (size 1.5 1.5)) (justify left))
    (uuid "{guid()}")
  )
  ...
  (symbol (lib_id "Connector:Conn_01x02") (at {j1_x} {j1_y} 0) (unit 1)
    ...
    (uuid "{guid()}")
    (property "Reference" "J1" (at {j1_x - 2} {j1_y - 4} 0) (effects (font (size 1.5 1.5) bold) (justify left)))
    (property "Value" "USB-C 5V" (at {j1_x + 3} {j1_y + 1} 0) (effects (font (size 1.27 1.27)) (justify left)))
  ...
  (symbol (lib_id "Device:C") (at {c1_x} {c1_y} 0) (unit 1)
    (exclude_from_sim no) (in_bom yes) (on_board yes) (dnp no)
    (uuid "{guid()}")
    (property "Reference" "C1" (at {c1_x - 5} {c1_y - 2} 0) (effects (font (size 1.5 1.5) bold) (justify left)))
    (property "Value" "100µF" (at {c1_x + 2} {c1_y} 0) (effects (font (size 1.27 1.27)) (justify left)))
  ...
  (symbol (lib_id "Device:R") (at {r1_x} {r1_y} 0) (unit 1)
    ...
    (property "Value" "330Ω" (at {r1_x - 2.5} {r1_y} 90) (effects (font (size 1.27 1.27))))
  ...
  (symbol (lib_id "Connector:Conn_01x02") (at {j3_x} {j3_y} 0) (unit 1)
    (exclude_from_sim no) (in_bom yes) (on_board yes) (dnp no)
    (uuid "{guid()}")
    (property "Reference" "J3" (at {j3_x - 2} {j3_y - 4} 0) (effects (font (size 1.5 1.5) bold) (justify left)))
    (property "Value" "IEC C14" (at {j3_x + 3} {j3_y + 1} 0) (effects (font (size 1.27 1.27)) (justify left)))
  ...
  (symbol (lib_id "Device:Fuse") (at {f1_x} {f1_y} 0) (unit 1)
    ...
    (property "Value" "10A" (at {f1_x - 2.5} {f1_y} 90) (effects (font (size 1.27 1.27))))
  ...
  (symbol (lib_id "Connector:Conn_01x02") (at {j4_x} {j4_y} 0) (unit 1)
    (exclude_from_sim no) (in_bom yes) (on_board yes) (dnp no)
    (uuid "{guid()}")
    (property "Reference" "J4" (at {j4_x - 2} {j4_y - 4} 0) (effects (font (size 1.5 1.5) bold) (justify left)))
    (property "Value" "Cooktop" (at {j4_x + 3} {j4_y + 1} 0) (effects (font (size 1.27 1.27)) (justify left)))
  ...
  (wire (pts (xy {j1_x - 5.08} {j1_y}) (xy {j1_x - 5.08} {j1_y - 7}))
    (stroke (width 0.5) (type default))
    (uuid "{guid()}")
  )

  (wire (pts (xy {j1_x - 5.08} {j1_y - 7}) (xy {c1_x} {c1_y - 7}))
    (stroke (width 0.5) (type default))
    (uuid "{guid()}")
  )

  (wire (pts (xy {c1_x} {c1_y - 7}) (xy {c1_x} {c1_y - 3.81}))
    (stroke (width 0.5) (type default))
    (uuid "{guid()}")
  )
  ...
  (wire (pts (xy {j1_x - 5.08} {j1_y + 2.54}) (xy {j1_x - 5.08} {j1_y + 13}))
    (stroke (width 0.5) (type default))
    (uuid "{guid()}")
  )

  (wire (pts (xy {j1_x - 5.08} {j1_y + 13}) (xy {c1_x} {c1_y + 13}))
    (stroke (width 0.5) (type default))
    (uuid "{guid()}")
  )

  (wire (pts (xy {c1_x} {c1_y + 13}) (xy {c1_x} {c1_y + 3.81}))
    (stroke (width 0.5) (type default))
    (uuid "{guid()}")
  )
  ...
  (wire (pts (xy {r1_x - grid(8)} {r1_y - 3.81}) (xy {r1_x} {r1_y - 3.81}))
    (stroke (width 0.4) (type default))
    (uuid "{guid()}")
  )

  (wire (pts (xy {r1_x} {r1_y + 3.81}) (xy {r1_x + grid(8)} {r1_y + 3.81}))
    (stroke (width 0.4) (type default))
    (uuid "{guid()}")
  )


  (wire (pts (xy {j3_x - 5.08} {j3_y}) (xy {j3_x - 5.08} {j3_y - 3.5}))
    (stroke (width 1.2) (type default))
    (uuid "{guid()}")
  )

  (wire (pts (xy {j3_x - 5.08} {j3_y - 3.5}) (xy {f1_x} {f1_y - 3.5}))
    (stroke (width 1.2) (type default))
    (uuid "{guid()}")
  )

  (wire (pts (xy {f1_x} {f1_y - 3.5}) (xy {f1_x} {f1_y - 3.81}))
    (stroke (width 1.2) (type default))
    (uuid "{guid()}")
  )

  (wire (pts (xy {f1_x} {f1_y + 3.81}) (xy {f1_x} {f1_y + 4.5}))
    (stroke (width 1.2) (type default))
    (uuid "{guid()}")
  )

  (wire (pts (xy {f1_x} {f1_y + 4.5}) (xy {f1_x + grid(5)} {f1_y + 4.5}))
    (stroke (width 1.2) (type default))
    (uuid "{guid()}")
  )

  (label "SSR_HOT_IN" (at {f1_x + grid(2)} {f1_y + 4.5} 0) (fields_autoplaced yes)
    (effects (font (size 1.4 1.4) bold) (justify left bottom))
    (uuid "{guid()}")
  )

  (wire (pts (xy {f1_x + grid(10)} {f1_y + 4.5}) (xy {f1_x + grid(15)} {f1_y + 4.5}))
    (stroke (width 1.2) (type default))
    (uuid "{guid()}")
  )

  (label "SSR_HOT_OUT" (at {f1_x + grid(10)} {f1_y + 4.5} 0) (fields_autoplaced yes)
    (effects (font (size 1.4 1.4) bold) (justify left bottom))
    (uuid "{guid()}")
  )

  (wire (pts (xy {f1_x + grid(15)} {f1_y + 4.5}) (xy {f1_x + grid(15)} {j4_y}))
    (stroke (width 1.2) (type default))
    (uuid "{guid()}")
  )

  (wire (pts (xy {f1_x + grid(15)} {j4_y}) (xy {j4_x - 5.08} {j4_y}))
    (stroke (width 1.2) (type default))
    (uuid "{guid()}")
  )
  ...
  (label "AC_HOT" (at {j3_x - 3} {j3_y - 1.5} 0) (fields_autoplaced yes)
    (effects (font (size 1.4 1.4) bold) (justify left bottom))
    (uuid "{guid()}")
  )

  (label "AC_NEUTRAL" (at {j3_x + grid(5)} {j3_y + 2.54} 0) (fields_autoplaced yes)
    (effects (font (size 1.4 1.4)) (justify left bottom))
    (uuid "{guid()}")
  )

  (label "ESP32_GPIO4" (at {r1_x - grid(8)} {r1_y - 3.81} 0) (fields_autoplaced yes)
    (effects (font (size 1.3 1.3)) (justify left bottom))
    (uuid "{guid()}")
  )

  (label "SSR_CTRL" (at {r1_x + grid(4)} {r1_y + 3.81} 0) (fields_autoplaced yes)
...
print("✅ STEP 10: Professional Clean Layout!")
print(f"\n🎨 IMPROVEMENTS:")
print(f"  • Better component spacing and alignment")
print(f"  • All wires horizontal/vertical (no diagonals)")
print(f"  • Visual isolation barrier (dashed line)")
print(f"  • Cleaner label hierarchy")
print(f"  • Better section headers")
print(f"  • Professional reference designators")
print(f"\n📐 LAYOUT:")
print(f"  DC Side: J1 → C1 → +5V/GND power rails")
print(f"  Control: ESP32_GPIO4 → R1 → SSR_CTRL")
print(f"  Barrier: Visual dashed line at {barrier_x}mm")
